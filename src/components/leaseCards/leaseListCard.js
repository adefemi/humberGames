...
export const getPropertyOwner = unit => {
  let property_owner;
  if (unit.property.property_owner) {
    property_owner = {
      profile_picture: unit.property.property_owner.user.user_profile
        ? unit.property.property_owner.user.user_profile.profile_picture.file
        : getNoImage(),
      first_name: unit.property.property_owner.user.first_name,
      last_name: unit.property.property_owner.user.last_name,
      email: unit.property.property_owner.user.email
    };
  } else {
    property_owner = {
      profile_picture: unit.property.property_creator.user_profile
        ? unit.property.property_creator.user_profile.profile_picture.file
        : getNoImage(),
      first_name: unit.property.property_creator.first_name,
      last_name: unit.property.property_creator.last_name,
      email: unit.property.property_creator.email
    };
  }
...
function LeaseListCard(props) {
  const {
    application: { unit, user }
  } = props.lease;
  return (
    <div className=" flex lease-list-card">
      <div
        className="img-con"
        style={{
      ...
      <div className="flex justify-between analysis-con">
        <div className="flex column justify-between processes">
        ...
        <div className="flex column justify-between controls">
