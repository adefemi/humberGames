const stagingBaseUrl = "http://staging.api.humbergames.com/";
const stagingGameUrl = "http://staging.gaming-service.humbergames.com/";
...
export const CUSTOMER_WINNING_URL = GAME_BASE_URL + "customer-winnings";
